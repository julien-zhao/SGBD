    ...
    public void execute() throws IOException {
        ...
        for(Record r : records){
            ...
            if(ok){
                ...
                //delete and update 
                Vector<PageId> pagesR = fm.getAllDataPages(relation);
                System.out.println("relation: "+relation+"; ri.recordId: "+r);
                //fm.deleteRecordInRelation(relation,r.getRelInfo());
                //fm.deleteRecordInDataPage(r.getRelInfo().getHeaderPageId(),null);
                System.out.println("relation: "+relation+"; ri.recordId: "+r);
                nb++;
                }
            }
                ...
                while(ri.hasNext()){
                    ...
                    while(ri2.hasNext()){
                        ...
                        if(ok){
                            ...
                            nb++;
                            //delete relation in page
                            System.out.println("relation: "+relation+"ri.recordId"+ri.recordId);
                            fm.deleteRecordInRelation(relation, ri.recordId);
                            fm.deleteRecordInDataPage(p, ri.recordId);
                            System.out.println("relation: "+relation+"ri.recordId"+ri.recordId);
                        }
                    }
                    ri2.reset();
